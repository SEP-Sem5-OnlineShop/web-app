const AlertComponent = () => {
    return (
        <div className="flex justify-between rounded-2xl overflow-hidden shadow-md bg-white h-28 sm:h-36" >
            <img src="img/item1.png" alt="item1" className="h-full w-20 sm:w-36 sm:h-36 object-cover"/>
            <div className="mx-2 my-2 flex flex-col justify-between items-center">
                ...
                <div className="sm:mt-1 flex flex-row justify-between items-center">
                    ...
                    <span className="mx-1 text-lg sm:text-xl text-secondary">10</span>
                    <button className="rounded-xl shadow w-8 h-8 sm:w-10 sm:h-10 flex justify-center items-center bg-white transform hover:scale-105 hover:shadow-md transition ease-out duration-400">
                        <span className="text-3xl sm:text-4xl text-text">+</span>
                    </button>
                </div>
